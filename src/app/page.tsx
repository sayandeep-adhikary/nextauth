...
export default function Home() {
  ...
  return (
    <div className="h-screen pb-14 relative">
      <Image src={bg} alt="bg" fill={true} className="-z-10" />
      ...
      <div className="container pt-0 md:pt-10 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
          ...
          <p className="leading-normal text-base md:text-2xl mb-8 text-center md:text-left slide-in-bottom-subtitle">
            A simple and secure web application built with NextJS 14 and
            shadcn/ui.
          </p>
